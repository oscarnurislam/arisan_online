    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('welcome') }}">
                ...
                <div class="sidebar-brand-text mx-3">ARISAN ONLINE</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('peserta.index') }}">Peserta</a>
                        <a class="collapse-item" href="{{ route('setoran.index') }}">Setoran</a>
                        <a class="collapse-item" href="{{ route('status.index') }}">Status</a>
                        <div class="collapse-divider"></div>
                        <h6 class="collapse-header">Hasil : </h6>
                        <a class="collapse-item" href="{{ route('kocok') }}">Kocok Hasil</a>
